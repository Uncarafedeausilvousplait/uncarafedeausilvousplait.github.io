...
**Linkedin:** [https://www.linkedin.com/in/aaron-adams1611](https://www.linkedin.com/in/aaron-adams1611) 
**Portfolio:** [https://uncarafedeausilvousplait.github.io/](https://uncarafedeausilvousplait.github.io/)  
**EXPERIENCE**  
**Cybersecurity Self Study:** Paintsville KY — *BowTiedCyber LLC* May 2024 •    Python scripting for creating tools, automation of testing processes for running network scans to safeguard resources.. •    Creation and management of a Highly Available content server available all over the world, prioritizing uptime and UX. •    Application of a Network Sniffer for the purpose of capturing network traffic to follow or recompose conversations and filter by protocol, port numbers, IP addresses or other network traffic characteristics. •    Utilization of wireless capturing suites for the purposes of capturing handshakes (WPA, WPA2), IVs (WEP), and researching MITM attacks, Evil Twin attacks, DOS attacks and MAC address spoofing. •    Exploration of exploitation frameworks to search and designate vulnerabilities in systems based on operating systems, version numbers, open ports, traffic filtering, etc. •    Malware analysis on live machines, including first and second stage viruses, ransomware, droppers, and Trojan Horses.  
